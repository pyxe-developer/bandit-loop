...
def main() -> int:
    ...
    codex_only = {
        fixture["name"]
        for fixture in load_fixture_file("install-agents.json")["fixtures"]
    }
    codex_only.update(
        fixture["name"]
        for fixture in load_fixture_file("hooks-mcp.json")["fixtures"]
    )
    counts = {
    ...
    supported = expected_names - codex_only
    ...
    counts["codex_only_integrations_skipped"] = len(codex_only)
